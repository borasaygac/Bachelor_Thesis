...
```
cd existing_repo
git remote add origin https://gitlab2.cip.ifi.lmu.de/saygac/thesis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab2.cip.ifi.lmu.de/saygac/thesis/-/settings/integrations)
